...
public class Microprocessor {
    ...
    private Register r1 = new Register(1, b.extend("0", 32));
    private Register r2 = new Register(2, b.extend("0", 32));
    private Register r3 = new Register(3, b.extend("0", 32));
    private Register r4 = new Register(4, b.extend("0", 32));
    private Register r5 = new Register(5, b.extend("0", 32));
    private Register r6 = new Register(6, b.extend("0", 32));
    private Register r7 = new Register(7, b.extend("0", 32));
    ...
    private int ind = 0;
    private String[] instructionSyntax = new String[256];
    ...
    private void initialize(File file) throws IOException{
        ...
        while(line != null) {
        	...
        	instructionSyntax[ind] = line; ind+=2;
		...
		line = br.readLine(); ind=0;// fills instruction array
    ...
    public Binary getBinary() {return b;}
